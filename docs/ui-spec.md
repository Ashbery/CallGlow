...
- F 邊緣星海（D17.4 再貼邊＋高亮，使用者：「再往邊緣一點、更顯眼、星星高亮」）：EdgeHaloView
  星點收斂至半徑 0.90–0.99（緊貼螢幕邊）：星雲底霧（兩道淡紫/淡青 radial，alpha ≤0.06）
  ＋微星 ×250（0.4–1.2dp、五色淡彩、各自閃爍）＋亮星 ×28（1.6–2.7dp、十字星芒＋size×3 光暈）
  ＋高亮星 ×8（2.2–3.2dp 純白核心＋size×4.5 大光暈＋長星芒，慢速呼吸），
  3.5s 呼吸（alpha 0.2→0.6）＋48s 公轉；畫於星空下、內容上。
