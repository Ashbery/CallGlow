...
- F 現代光環（D17.6，使用者：回歸光環＋更帥更現代）：EdgeHaloView 多層光環＋雙向軌道彗星——
  寬柔光帶 10dp（銀河底光）＋分段亮弧 4dp（紫/青/洋紅＋缺口，活動環分段感）＋細亮核心 2dp
  ＋軌道彗星 ×2（青白順時針 12s/圈、洋紅逆時針 9s/圈；頭部亮點＋光暈＋漸隱拖尾，衛星繞行感）
  ＋微星 ×10 點綴；3s 呼吸（0.25→0.6）＋光環本體 40s 緩轉。
