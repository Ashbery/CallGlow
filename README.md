...
1. 到 [Releases](https://github.com/Ashbery/CallGlow/releases) 下載 **CallGlow-v1.0.1-installer.zip** 並解壓縮
...
從 [Releases](https://github.com/Ashbery/CallGlow/releases) 下載 **CallGlow-v1.0.1-installer.zip**，
