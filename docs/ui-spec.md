...
- F 邊緣星海（D17.3 調密，使用者：「更密，但要密集在原本光環那一圈」）：EdgeHaloView
  星點收斂至半徑 0.84–0.97 窄帶（貼螢幕邊一圈）：星雲底霧（兩道淡紫/淡青 radial，alpha ≤0.06）
  ＋微星 ×230（0.35–1.1dp、五色淡彩、各自閃爍）＋亮星 ×24（1.5–2.6dp、十字星芒隨閃爍伸縮），
  3.5s 呼吸（alpha 0.2→0.6）＋48s 公轉（星海漂流感）；畫於星空下、內容上。
