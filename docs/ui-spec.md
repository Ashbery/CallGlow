...
- F 邊緣星海（D17.2 改版，使用者：「不一定要線條光環，可以是一圈星海」）：EdgeHaloView
  完全移除線條——沿圓屏外圈 70%–97% 半徑環帶：星雲底霧（兩道淡紫/淡青 radial，alpha ≤0.06）
  ＋微星 ×110（0.4–1.2dp、五色淡彩、各自閃爍）＋亮星 ×16（1.6–2.8dp、十字星芒隨閃爍伸縮），
