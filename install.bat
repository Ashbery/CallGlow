...
echo   [1/5] 安裝手機端 APP……
echo  ============================================================
call adb -s !PH! install -r "%~dp0CallGlow-Phone-v1.0.0.apk" || (echo [失敗] 手機 APK 安裝失敗 & pause & exit /b 1)
echo    [OK] 手機端已安裝
...
echo   [3/5] 安裝手錶端 APP……
echo  ============================================================
call adb -s !WT! install -r "%~dp0CallGlow-Watch-v1.0.0.apk" || (echo [失敗] 手錶 APK 安裝失敗 & pause & exit /b 1)
echo    [OK] 手錶端已安裝
